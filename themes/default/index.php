...
<body>
    ...
    <script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>todo.js?"></script>
    <script type="text/javascript" src="<?php mttinfo('mtt_url'); ?>todo_ajax_storage.js"></script>

    <script type="text/javascript">
        $().ready(function () {
            todo.appUrl = "<?php mttinfo('mtt_url'); ?>";
            todo.templateUrl = "<?php mttinfo('template_url'); ?>";
